...
const char *gengetopt_args_info_help[] = {
  ...
  "      --pruneDeadEnds           enable pruning based on precs and effs of\n                                  compound tasks  (default=off)",
  "      --optSol                  Optimize solution until time limit is reached\n                                  (default=off)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->pruneDeadEnds_given = 0 ;
  args_info->optSol_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->pruneDeadEnds_flag = 0;
  args_info->optSol_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->pruneDeadEnds_help = gengetopt_args_info_help[22] ;
  args_info->optSol_help = gengetopt_args_info_help[23] ;
  args_info->noVisitedList_help = gengetopt_args_info_help[26] ;
  args_info->noTaskHash_help = gengetopt_args_info_help[27] ;
  args_info->noTaskSequenceHash_help = gengetopt_args_info_help[28] ;
  args_info->noTopologicalOrdering_help = gengetopt_args_info_help[29] ;
  args_info->noLayers_help = gengetopt_args_info_help[30] ;
  args_info->noOrderPairs_help = gengetopt_args_info_help[31] ;
  args_info->noParallelSequences_help = gengetopt_args_info_help[32] ;
  args_info->noGIcheck_help = gengetopt_args_info_help[33] ;
  args_info->blockcompression_help = gengetopt_args_info_help[35] ;
  args_info->satmutexes_help = gengetopt_args_info_help[36] ;
  args_info->pruning_help = gengetopt_args_info_help[37] ;
  args_info->methodPreconditionsInSeparateLeafs_help = gengetopt_args_info_help[38] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->pruneDeadEnds_given)
    write_into_file(outfile, "pruneDeadEnds", 0, 0 );
  if (args_info->optSol_given)
    write_into_file(outfile, "optSol", 0, 0 );
...
.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* enable pruning based on precs and effs of compound tasks.  */
          else if (strcmp (long_options[option_index].name, "pruneDeadEnds") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->pruneDeadEnds_flag), 0, &(args_info->pruneDeadEnds_given),
                &(local_args_info.pruneDeadEnds_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "pruneDeadEnds", '-',
                additional_error))
              goto failure;
          
          }
          /* Optimize solution until time limit is reached.  */
          else if (strcmp (long_options[option_index].name, "optSol") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->optSol_flag), 0, &(args_info->optSol_given),
                &(local_args_info.optSol_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "optSol", '-',
                additional_error))
              goto failure;
