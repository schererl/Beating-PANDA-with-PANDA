...
struct gengetopt_args_info
{
 ...
 help description.  */
  ...
  int pruneDeadEnds_flag;	/**< @brief enable pruning based on precs and effs of compound tasks (default=off).  */
  const char *pruneDeadEnds_help; /**< @brief enable pruning based on precs and effs of compound tasks help description.  */
  int optSol_flag;	/**< @brief Optimize solution until time limit is reached (default=off).  */
  const char *optSol_help; /**< @brief Optimize solution until time limit is reached help description.  */
  ...
  unsigned int pruneDeadEnds_given ;	/**< @brief Whether pruneDeadEnds was given.  */
  unsigned int optSol_given ;	/**< @brief Whether optSol was given.  */
